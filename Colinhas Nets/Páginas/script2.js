...
function acionartransportadora() {
  ...
  var message = "Olá, Central.\n\n"+
                "Transportadora acionada, solicitamos agilidade na entrega e atualização no rastreamento, aguardamos retorno da transportadora.\n\n" +                
                 myImput + "\n" +
                "Backoffice Netshoes";
  // Copia a mensagem para a área de transferência
  navigator.clipboard.writeText(message)
...
function acionartransportadoradev() {
  var currentDate = new Date();
  var daysToAdd = 4; // Número de dias úteis a serem adicionados
  ...
  var message = "Olá, Central.\n\n"+
                "Transportadora acionada, solicitamos devolução na entrega e atualização no rastreamento, aguardamos retorno da transportadora.\n\n" +                
                 myImput + "\n" +
                "Backoffice Netshoes";
  // Copia a mensagem para a área de transferência
  navigator.clipboard.writeText(message)
...
function solidevol() {
  ...
  var message = "Olá, Central.\n\n"+
                "Transportadora acionada, foi solicitada a devolução do item ao estoque para podermos seguir com o atendimento ao cliente, aguardamos retorno até o dia xx/08.\n\n" +                
                 myImput + "\n" +
                "Backoffice Netshoes";
  // Copia a mensagem para a área de transferência
  navigator.clipboard.writeText(message)
...
function rotadevol() {
  ...
  var message = "Olá, Central.\n\n"+
                "Pedido se encontra em rota de devolução ao estoque do seller, cliente será atendido com vale compras.\n\n" +                
                 myImput + "\n" +
                "Backoffice Netshoes";
  // Copia a mensagem para a área de transferência
  navigator.clipboard.writeText(message)
...
function extravio() {
  ...
  var message = "Olá, Central.\n\n"+
                "Pedido foi extraviado, cliente será atendido com vale compras.\n\n" +                
                 myImput + "\n" +
                "Backoffice Netshoes";
  // Copia a mensagem para a área de transferência
  navigator.clipboard.writeText(message)
...
function dadosreceb1() {
  ...
  var message = "Olá, prezados.\n\n"+
                "Pedido consta entregue, mas cliente afirma não ter recebido. Por gentileza, retornar com o comprovante de entrega até o prazo final do protocolo. \n" +       
                "Caso não tivermos retorno, podemos atender o cliente.\n\n" +              
                 myImput + "\n" +
                "Backoffice Netshoes";
  // Copia a mensagem para a área de transferência
  navigator.clipboard.writeText(message)
